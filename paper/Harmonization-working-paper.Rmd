...
title: |
  |
  | 
  | \vspace{1cm}Survey Data Harmonization: A Reproducible Workflow and Toolbox*^[*Corresponding address: mkolczynska@isppan.waw.pl. Acknowledgments: I am grateful to all those generous people who invest their time into open-source software and reproducible research, as well as Przemek Powałko, and funding from Poland's National Science Centre (2019/32/C/HS6/00421).]\vspace{0.5cm}
  |
author: |
  | Marta Kołczyńska
