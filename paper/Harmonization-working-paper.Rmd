...
title: |
  |
  | 
  | \vspace{1cm}DIY Survey Data Harmonization: A Reproducible Workflow and Toolbox*^[*Corresponding address: mkolczynska@isppan.waw.pl. Acknowledgments: I am grateful to all those generous people who invest their time into open-source software and reproducible research, as well as Przemek Powałko.]\vspace{0.5cm}
  |
author: |
  | Marta Kołczyńska
...
Small-scale projects tend to provide supplementary materials for the respective publications, the content of which is not standardized, and may include additional analyses, code, original and/or cleaned data.

An analysis of political trust and democratic values by @Mauk2019 relied on on data from six cross-national survey projects from a hundred countries with almost global coverage. Replication materials, also stored on Dataverse, include a recoding syntax file with all the code necessary to create the harmonized variables used in subsequent analyses. The harmonized data set is not provided [@mauk2019repmat].

More studies are using survey data to examine changes, causes and consequences of public opinion measured on the societal level, including both single-country studies [@Bartle2011; @Bartle2020; @Chanley2000; @English2019; @Hetherington2008; @Luttig2013; @Stimson1999; @Stimson2012; @Stimson2018; @Wolak2020] as well as cross-national analyses covering Europe [@Caughey2019; @Guinaudeau2019] or most countries of the world [@Claassen2019]. 
