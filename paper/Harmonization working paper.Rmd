...
title: |
  |
  | 
  | \vspace{1cm}DIY Survey Data Harmonization: A Reproducible Worlflow and Toolbox*^[*Corresponding address: kolczynska.1@osu.edu. Acknowledgments: I am grateful to all those generous people who invest their time into open-source software and reproducible research.]\vspace{0.5cm}
  |
author: |
  | Marta Kołczyńska
...
In all cases, but especially if not all data processing steps can be automated, the code should be annotated. Following @Liu2019, code documents should include information about the general purpose of the code segment, as well as a description of the input, the outputs, the type of machine used, and the expected runtime.
