...
```{r codebook, fig.cap="Codebook table.", out.width = "465px", echo = FALSE}
...
```{r cwt, fig.cap="Crosswalk table.", out.width = "465px", echo = FALSE}
...
## Results: Comparing average levels of trust in the police



```{r graph, warning=FALSE, message=FALSE, echo = FALSE, fig.width = 6, fig.height = 8, fig.cap="Country-year levels of trust in the police by aggregate type."}
